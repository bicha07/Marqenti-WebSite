            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/{{auth()->user()->avatar}}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        <a type="button" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2" data-bs-toggle="modal" data-bs-target="#editImageModal">
          ...
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="#" id="loadUserProfile" data-bs-toggle="modal" data-bs-target="#exampleModalMessage" type="button">
            ...
            <div class="card-body p-3">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; (216) {{ auth()->user()->phone }}</li>
            ...
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  ...
                  <a class="btn btn-outline-dark pe-2 ps-2 mb-0 ms-auto" href="javascript:;">Reply</a>
                </li>
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="avatar me-3">
                  ...
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="button" class="btn btn-outline-dark btn-sm mb-0">View Project</button>
                  ...
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="avatar-group mt-2">
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Nick Daniel">
                            <img alt="Image placeholder" src="../assets/img/default.jpg">
                          </a>
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Peterson">
                            <img alt="Image placeholder" src="../assets/img/team-4.jpg">
                          </a>
...
<div class="modal fade" id="editImageModal" tabindex="-1" role="dialog" aria-labelledby="editImageModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="imageForm" action="{{ route('user.update-profile-image') }}" method="POST" enctype="multipart/form-data">
                    @csrf 
                    <div class="form-group">
                        <label for="avatar" class="col-form-label">Select Image:</label>
                        <input type="file" class="form-control" id="avatar" name="avatar" required accept="image/*" onchange="previewImage(this)">
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="imageForm" class="btn bg-gradient-dark">Update Image</button>
            </div>
        </div>
    </div>
</div>
