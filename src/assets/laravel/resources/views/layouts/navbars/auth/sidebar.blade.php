...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/lola.svg" width="50" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">MarQenti Dashboard</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        ...
        <a class="nav-link {{ (Request::is('services') ? 'active' : '') }}" href="{{ url('services') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('services') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">service Management</span>
        </a>
      </li>
                  <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('packs') ? 'active' : '') }}" href="{{ url('packs') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('packs') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
    ...
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          ...
          <p class="text-xs font-weight-bold">Open a Ticket</p>
          <a href="https://www.marqenti.tn/contact.html" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Contact us</a>
        </div>
      </div>
    </div>
  </div>
