...
<!--        <li class="nav-item">
      ...
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="https://www.marqenti.tn/contact.html" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}">Contact Us</a>
        </li>
      </ul>
    </div>
  </div>
